...
namespace Jiten.Parser
{
    public static class Parser
    {
        ...
        [
            ...
            (2759530, 0), (1429010, 1), (2871946, 0), (2871946, 1), (2872080, 0), (2872080, 1),
            (1583240, 5), (2619520, 0)
        ];
            ...
            ConcurrentDictionary<int, JmDictWord>? batchWordCache = null)
        {
            ...
            else
            {
                ...
                if (text.Length >= 3 && WanaKana.IsKana(text))
                {
            ...
            ConcurrentDictionary<int, JmDictWord>? batchWordCache = null)
        {
            ...
            foreach (var form in deconjugated)
            {
                if (_lookups.TryGetValue(form.Text, out List<int>? lookup))
                {
                    ...
                    if (katakanaNounSurface && form.Process.Count > 0 && !form.Tags.Contains("n"))
                    {
