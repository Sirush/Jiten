<script setup lang="ts">
  ...
  import type { VocabularyModifierMode } from '~/composables/useVocabularyDisplayFilter';
  ...
  const displayTiers = defineModel<string[]>('displayTiers', { default: () => [] });
  const suspended = defineModel<VocabularyModifierMode>('suspended', { default: 'show' });
  const redundant = defineModel<VocabularyModifierMode>('redundant', { default: 'show' });
