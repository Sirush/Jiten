<script setup lang="ts">
  ...
  import { Chart as ChartJS, LogarithmicScale, LinearScale, PointElement, LineElement, Tooltip, Legend, type ChartOptions, type ChartData } from 'chart.js';
  ...
  const chartOptions = computed<ChartOptions<'line'>>(() => ({
    ...
    scales: {
      x: {
        ...
        title: {
          display: true,
          text: isLogScale.value ? 'Number of Most Frequent Words Learned (Log Scale)' : 'Number of Most Frequent Words Learned (Linear Scale)',
