  ...
  <div class="container mx-auto p-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
      ...
      <Select
        ...
        class="w-full"
      />
      <InputText v-model="searchQuery" placeholder="Search external tag name..." class="w-full" />
      <Button label="Clear Filters" icon="pi pi-filter-slash" severity="secondary" @click="clearFilters" />
    </div>
    ...
    <!-- Create/Edit Dialog -->
    <Dialog v-model:visible="showDialog" :header="dialogMode === 'create' ? 'Create Tag Mapping' : 'Edit Tag Mapping'" :modal="true" class="w-full md:w-1/2">
      <div class="p-fluid">
        <div class="mb-4">
        ...
        <div class="mb-4">
          ...
          <InputText id="externalTagName" v-model="formData.externalTagName" placeholder="Enter external tag name" class="w-full" />
        </div>
        <div class="mb-4">
