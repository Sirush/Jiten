...
namespace Jiten.Core.Migrations
{
    ...
    [Migration("20251113162810_AddNgramTables")]
    partial class AddNgramTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jiten.Cli.NGrams.NgramProcessingQueue", b =>
                {
                    ...
                    b.ToTable("NgramProcessingQueue", "jiten");
                });

            modelBuilder.Entity("Jiten.Cli.NGrams.NgramSource", b =>
                {
                    b.Property<int>("NgramId")
                        .HasColumnType("integer");
                    ...
                    b.Property<short>("WordPosition")
                        .HasColumnType("smallint");

                    b.HasKey("NgramId", "ExampleSentenceId");
                    ...
                    b.ToTable("NgramSources", "jiten");
                });

            modelBuilder.Entity("Jiten.Cli.NGrams.NgramStatistics", b =>
                {
                    b.Property<int>("WordId")
                        .HasColumnType("integer");

                    b.Property<float?>("AmbiguityScore")
                        .HasColumnType("real");

                    b.Property<float>("AvgSignificanceScore")
                        .HasColumnType("real");

                    b.Property<int>("BertEmbeddingsComputed")
                        .HasColumnType("integer");

                    b.Property<DateTimeOffset?>("LastProcessed")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("SignificantNgrams")
                        .HasColumnType("integer");

                    b.Property<int>("TotalNgrams")
                        .HasColumnType("integer");

                    b.HasKey("WordId");

                    b.HasIndex("AmbiguityScore")
                        .HasDatabaseName("IX_NgramStatistics_AmbiguityScore");

                    b.HasIndex("LastProcessed")
                        .HasDatabaseName("IX_NgramStatistics_LastProcessed");

                    b.ToTable("NgramStatistics", "jiten");
                });

            modelBuilder.Entity("Jiten.Cli.NGrams.PrecomputedNgram", b =>
                {
                    b.Property<int>("NgramId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("NgramId"));

                    b.PrimitiveCollection<float[]>("BertEmbedding")
                        .HasColumnType("real[]");

                    b.Property<bool>("BertEmbeddingComputed")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<float>("SignificanceScore")
                        .HasColumnType("real");

                    b.Property<short>("TokensAfter")
                        .HasColumnType("smallint");

                    b.Property<short>("TokensBefore")
                        .HasColumnType("smallint");
                    ...
                    b.HasIndex("BertEmbeddingComputed")
            ...
            modelBuilder.Entity("Jiten.Cli.NGrams.NgramProcessingQueue", b =>
                {
                    b.HasOne("Jiten.Cli.NGrams.PrecomputedNgram", "Ngram")
                        .WithMany()
                        .HasForeignKey("NgramId")
