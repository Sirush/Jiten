...
namespace Jiten.Core.Migrations
{
    ...
    [Migration("20260925182515_ReplaceExampleSentenceWordsWithTokens")]
    partial class ReplaceExampleSentenceWordsWithTokens
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jiten.Core.Data.Deck", b =>
                {
                    ...
                    b.Property<float>("DifficultyOverride")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Jiten.Core.Data.DeckDictionaryEntry", b =>
                {
                    b.Property<int>("DeckDictionaryEntryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("DeckDictionaryEntryId"));
            ...
            modelBuilder.Entity("Jiten.Core.Data.DeckDifficulty", b =>
                {
                    ...
                    b.Property<int>("HarderVoteCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
                    ...
                    b.Property<decimal>("UserAdjustment")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(4, 2)
                        .HasColumnType("numeric(4,2)")
                        .HasDefaultValue(0m);
            ...
            modelBuilder.Entity("Jiten.Core.Data.DeckTitle", b =>
                {
                    ...
                    b.Property<string>("TitleNoSpaces")
            ...
            modelBuilder.Entity("Jiten.Core.Data.DifficultyVote", b =>
                {
                    ...
                    b.Property<int>("DeckHighId")
                        .HasColumnType("integer");

                    b.Property<int>("DeckLowId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Jiten.Core.Data.JMDict.JmDictCrossReference", b =>
                {
                    ...
                    b.Property<int>("TargetDict")
                        .HasColumnType("int");

                    b.Property<string>("TargetKanji")
                        .HasColumnType("text");

                    b.Property<string>("TargetReading")
                        .HasColumnType("text");

                    b.Property<short?>("TargetSenseIndex")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("Jiten.Core.Data.JMDict.JmDictDefinition", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("Dial")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
                        .HasDefaultValueSql("'{}'");
                    ...
                    b.PrimitiveCollection<List<string>>("Field")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
                        .HasDefaultValueSql("'{}'");

                    b.PrimitiveCollection<List<string>>("GlossTypes")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
                        .HasDefaultValueSql("'{}'");

                    b.Property<bool>("IsActiveInLatestSource")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.PrimitiveCollection<List<string>>("Misc")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
                        .HasDefaultValueSql("'{}'");
                    ...
                    b.PrimitiveCollection<List<string>>("SenseInfo")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
                        .HasDefaultValueSql("'{}'");
            ...
            modelBuilder.Entity("Jiten.Core.Data.JMDict.JmDictWord", b =>
                {
                    ...
                    b.Property<string>("EntryInfoJson")
                        .HasColumnType("jsonb");

                    b.Property<string>("LanguageSourcesJson")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Jiten.Core.Data.JMDict.JmDictWordComposition", b =>
                {
                    ...
                    b.Property<short>("ComponentReadingIndex")
                        .HasColumnType("smallint");

                    b.Property<string>("ComponentSurface")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Jiten.Core.Data.JMDict.JmDictWordForm", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("InfoTags")
                        .HasColumnType("text[]");

                    b.Property<bool>("IsActiveInLatestSource")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsNoKanji")
                        .HasColumnType("boolean");
                    ...
                    b.HasKey("WordId", "ReadingIndex");

                    b.HasIndex("WordId")
                        .HasDatabaseName("IX_WordForms_WordId");

                    b.HasIndex("WordId", "FormType", "Text")
                        .IsUnique()
                        .HasDatabaseName("IX_WordForms_WordId_FormType_Text");

                    b.ToTable("WordForms", "jmdict");
                });

            modelBuilder.Entity("Jiten.Core.Data.JMDict.JmDictWordFormFrequency", b =>
                {
                    b.Property<int>("WordId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Jiten.Core.Data.JMDict.Kanji", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("KunReadings")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<List<string>>("Meanings")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<List<string>>("OnReadings")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Jiten.Core.Data.JMDict.WordKanji", b =>
                {
                    ...
                    b.HasKey("WordId", "ReadingIndex", "KanjiCharacter", "Position");

                    b.HasIndex("KanjiCharacter")
                        .HasDatabaseName("IX_WordKanji_KanjiCharacter");

                    b.HasIndex("WordId", "ReadingIndex")
                        .HasDatabaseName("IX_WordKanji_WordId_ReadingIndex");

                    b.ToTable("WordKanji", "jmdict");
                });
            ...
            modelBuilder.Entity("Jiten.Core.Data.SkippedComparison", b =>
                {
                    ...
                    b.ToTable("SkippedComparisons", "jiten");
                });
            ...
            modelBuilder.Entity("Jiten.Core.Data.WebNovel.WebNovelChapter", b =>
                {
                    ...
                    b.Property<bool>("RevisedAtSource")
                        .HasColumnType("boolean");
                    ...
                    b.HasKey("DeckId", "EpisodeNumber");

                    b.HasIndex("ChildDeckId")
                        .HasDatabaseName("IX_WebNovelChapters_ChildDeckId");

                    b.ToTable("WebNovelChapters", "jiten");
                });

            modelBuilder.Entity("Jiten.Core.Data.WebNovel.WebNovelSource", b =>
                {
                    b.Property<int>("DeckId")
                        .HasColumnType("integer");

                    b.Property<int?>("ChunkCharBudget")
                        .HasColumnType("integer");

                    b.Property<bool>("CompletedAtSource")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("OnHiatusAtSource")
                        .HasColumnType("boolean");

                    b.Property<int>("PendingRevisionCount")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("WebNovelSources", "jiten");
                });

            modelBuilder.Entity("Jiten.Core.Data.WordParentDeckIndex", b =>
                {
                    b.Property<int>("WordId")
                        .HasColumnType("integer");
                    ...
                    b.PrimitiveCollection<int[]>("DeckIds")
                        .IsRequired()
                        .HasColumnType("integer[]");

                    b.PrimitiveCollection<int[]>("Occurrences")
                        .IsRequired()
                        .HasColumnType("integer[]");

                    b.HasKey("WordId", "ReadingIndex");

                    b.ToTable("WordParentDeckIndex", "jiten");
                });

            modelBuilder.Entity("Jiten.Core.Data.WordParentDeckIndexBuild", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("WordParentDeckIndexBuild", "jiten");
                });
            ...
            modelBuilder.Entity("Jiten.Core.Data.DifficultyVote", b =>
                {
                    b.HasOne("Jiten.Core.Data.Deck", "DeckHigh")
                        .WithMany()
                        .HasForeignKey("DeckHighId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Jiten.Core.Data.Deck", "DeckLow")
                        .WithMany()
                        .HasForeignKey("DeckLowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Jiten.Core.Data.JMDict.JmDictWordComposition", b =>
                {
                    b.HasOne("Jiten.Core.Data.JMDict.JmDictWord", "Component")
                        .WithMany()
                        .HasForeignKey("ComponentWordId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Jiten.Core.Data.JMDict.WordKanji", b =>
                {
                    b.HasOne("Jiten.Core.Data.JMDict.Kanji", "Kanji")
                        .WithMany("WordKanjis")
                        .HasForeignKey("KanjiCharacter")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Jiten.Core.Data.MediaRequestComment", b =>
                {
                    ...
                    b.HasOne("Jiten.Core.Data.MediaRequestComment", "ParentComment")
            ...
            modelBuilder.Entity("Jiten.Core.Data.WebNovel.WebNovelSource", b =>
                {
                    b.HasOne("Jiten.Core.Data.Deck", "Deck")
                        .WithOne()
                        .HasForeignKey("Jiten.Core.Data.WebNovel.WebNovelSource", "DeckId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
