...
namespace Jiten.Core.Migrations.UserDb
{
    ...
    [Migration("20260919022816_NewCardCursor")]
    partial class NewCardCursor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jiten.Core.Data.Billing.BillingEmailLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("UserId", "Kind")
                        .HasDatabaseName("IX_BillingEmailLog_UserId_Kind");

                    b.ToTable("BillingEmailLogs", "user");
                });
            ...
            modelBuilder.Entity("Jiten.Core.Data.User.UserCardMedia", b =>
                {
                    ...
                    b.Property<string>("PreviousStoragePath")
                        .HasMaxLength(512)
            ...
            modelBuilder.Entity("Jiten.Core.Data.User.UserFsrsSettings", b =>
                {
                    ...
                    b.Property<int?>("NewCardCursorStudyDeckId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Jiten.Core.Data.UserLegalDocumentState", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTime?>("NoticeShownAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("UserId", "Document", "Version")
                        .IsUnique()
